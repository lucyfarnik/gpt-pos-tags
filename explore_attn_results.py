...
def get_pos_positions(tagged_sent: list) -> Tuple[List[int], List[int], List[int]]:
    noun_positions = []
    verb_positions = []
    adj_positions = []
    for i, pos in tagged_sent['pos_dict'].items():
    ...
    return noun_positions, verb_positions, adj_positions
...
if MAIN:
    ...
    for sent in data:
        noun_positions, verb_positions, adj_positions = get_pos_positions(sent)
